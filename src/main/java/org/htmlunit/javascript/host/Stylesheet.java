...
public class Stylesheet extends SimpleScriptable {
     ...
     */
    public org.htmlunit.javascript.host.css.CSSRuleList jsxGet_rules() {
     ...
     * @return the collection of rules defined in this style sheet
     */
    public org.htmlunit.javascript.host.css.CSSRuleList jsxGet_cssRules() {
        if (cssRules_ == null) {
            cssRules_ = new org.htmlunit.javascript.host.css.CSSRuleList(this);
        }
        return cssRules_;
    }
