...
import org.htmlunit.javascript.NamedNodeMap;
import org.htmlunit.javascript.ScriptableWithFallbackGetter;
import org.htmlunit.javascript.background.JavaScriptJob;
import org.htmlunit.javascript.host.Attr;
import org.htmlunit.javascript.host.BoxObject;
import org.htmlunit.javascript.host.Element;
import org.htmlunit.javascript.host.Event;
import org.htmlunit.javascript.host.EventHandler;
import org.htmlunit.javascript.host.MouseEvent;
import org.htmlunit.javascript.host.Node;
import org.htmlunit.javascript.host.TextRange;
import org.htmlunit.javascript.host.TextRectangle;
        ...
        if (node instanceof DomComment) {
            ...
            for (final DomAttr attr : element.getAttributesMap().values()) {
                ...
                final boolean quote = !ie
                    || org.htmlunit.util.StringUtils.containsWhitespace(value)
                    || value.length() == 0
